...
5. Click on **Configuration**
    - If you are using the Mosquitto broker addon, make sure you create a bot user for Zigbee2MQTT in **Settings → Users** and that the username is present in the `logins` list of the configuration of Mosquitto.
    - Fill in your MQTT details. Format can be found [here](https://www.zigbee2mqtt.io/guide/configuration/mqtt.html#server-connection), but skip the initial `mqtt:` indent. e.g.: <br>
        ```yaml
